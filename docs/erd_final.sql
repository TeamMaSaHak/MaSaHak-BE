-- ========================================
-- 마법사관학교 통합 ERD - SQL DDL
-- Supabase (PostgreSQL) 용
-- ========================================

-- ========================================
-- 기존 테이블 (profile_bot 확장)
-- ========================================
...
COMMENT ON TABLE users IS '디스코드 회원 정보';
COMMENT ON COLUMN users.user_id IS '디스코드 유저 ID';
COMMENT ON COLUMN users.guild_id IS '디스코드 서버 ID';
COMMENT ON COLUMN users.total_seconds IS '총 공부 시간(초)';
COMMENT ON COLUMN users.xp IS '경험치';
COMMENT ON COLUMN users.last_seen_at IS '마지막 접속';
COMMENT ON COLUMN users.nickname IS '닉네임';
COMMENT ON COLUMN users.student_no IS '학번 (YYYYMMDD + NN)';
COMMENT ON COLUMN users.status IS '상태 (active/left)';
COMMENT ON COLUMN users.level IS '레벨';
COMMENT ON COLUMN users.level_name IS '레벨명';
...
COMMENT ON TABLE voice_sessions IS '공부 세션 기록';
COMMENT ON COLUMN voice_sessions.session_id IS '세션 ID';
COMMENT ON COLUMN voice_sessions.user_id IS '유저 ID';
COMMENT ON COLUMN voice_sessions.guild_id IS '서버 ID';
COMMENT ON COLUMN voice_sessions.started_at IS '시작 시간';
COMMENT ON COLUMN voice_sessions.ended_at IS '종료 시간';
COMMENT ON COLUMN voice_sessions.duration_seconds IS '공부 시간(초)';
...
COMMENT ON TABLE daily_streaks IS '일별 출석 기록';
COMMENT ON COLUMN daily_streaks.user_id IS '유저 ID';
COMMENT ON COLUMN daily_streaks.guild_id IS '서버 ID';
COMMENT ON COLUMN daily_streaks.streak_date IS '출석 날짜';
...
COMMENT ON TABLE notification_settings IS '알림 설정 (카테고리별 확장 가능)';
